...
exports.PromoPortfolioPage = class PromoPortfolioPage {
    ...
    constructor(page) {
        ...
        this.last_event_in_grid = "(//tr[1]/td[@data-pc-section='bodycell']/div)[6]"  // Grid last Events
        this.last_uplift_in_grid = "(//tr[1]/td[@data-pc-section='bodycell']/div)[7]"  // Grid last Uplift
        this.last_roi_in_grid = "(//tr[1]/td[@data-pc-section='bodycell']/div)[8]"  // Grid last ROI
    ...
    async update_element() {
        ...
        const bp = new BasePage()
        const grid_name_before = await this.page.locator(bp.first_item_name).textContent();
        ...
        const grid_name_after = await this.page.locator(bp.first_item_name).textContent();
